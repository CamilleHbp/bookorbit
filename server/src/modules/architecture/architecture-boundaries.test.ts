...
describe('Architecture boundaries', () => {
  ...
  it('freezes direct DB injection in services to an explicit allowlist', async () => {
    const allowlist = [
      ...
      'src/modules/book-dock/book-dock-managed-upload.service.ts',
      'src/modules/book-dock/book-dock-managed.service.ts',
      'src/modules/book-revision/book-revision.service.ts',
      'src/modules/book-revision/canonical-reading.service.ts',
      'src/modules/book-revision/revision-catalog.service.ts',
      'src/modules/book-revision/revision-coordination.service.ts',
      'src/modules/book-revision/revision-download.service.ts',
      'src/modules/book-revision/revision-interruption.service.ts',
      'src/modules/book-revision/revision-publication.service.ts',
      'src/modules/fanfiction/fanfiction-activity.service.ts',
      'src/modules/fanfiction/fanfiction-adoption.service.ts',
      ...
      'src/modules/fanfiction/fanfiction-source.service.ts',
      'src/modules/koreader/koreader-copy.service.ts',
      'src/modules/koreader/koreader-delivery-access.service.ts',
      'src/modules/koreader/koreader-delivery-execution.service.ts',
      'src/modules/koreader/koreader-delivery-scheduler.service.ts',
      'src/modules/koreader/koreader-delivery.service.ts',
    ].sort();
