...
- Fork remote: `git@github.com:CamilleHbp/bookorbit.git` (origin). Fetch before work, preserve existing changes on a feature branch, synchronize verified implementation with GitHub, and never overwrite remote work or deploy unverified increments. Deploy the exact verified origin/main commit after integrating feature work.

- Follow the Git workflow in AGENTS.md: independent features start at upstream/main; optional subwork starts at its owning feature; main integrates verified work from both features. Only the user authorizes upstream PRs.
